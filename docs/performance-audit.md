...
### 构建统计（2025-12-29，analyze 模式）

```
主要输出:
- index.css: 37.36 KB (7.30 KB gzipped)
- react-vendor: 197.24 KB (64.86 KB gzipped)
- i18n-vendor: 48.57 KB (14.68 KB gzipped)
- 主入口: 273.08 KB (74.78 KB gzipped)
- 页面 chunks: 1.00 KB ~ 64.79 KB (0.56 KB ~ 18.62 KB gzipped)
...
-语言切换按钮功能 - 本地存储持久化 - 页面重新加载后状态保持 - 文本内容正确切换;
```
